# Generated by Django 3.1 on 2020-09-22 15:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='article_images', related_query_name='image', to='blog.article')),
            ],
        ),
        migrations.AddField(
            model_name='article',
